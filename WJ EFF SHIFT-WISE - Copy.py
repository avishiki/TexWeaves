...
if not df_fy.empty:
    ...
    monthly_grouped = df_fy.groupby(['FY_Sort', 'Year', 'Month_Name', 'Quality']).agg({
        'YARN_COST_FINAL': 'mean', # Added Yarn Cost
        'daily_looms': 'sum',
    ...
    monthly_grouped['TOTAL LABOUR COST'] = (
     ...
     # Total Cost = Labour + EMI + Yarn Cost
    monthly_grouped['TOTAL COST'] = (
        monthly_grouped['TOTAL LABOUR COST'] + 
        monthly_grouped['EMI'] + 
        monthly_grouped['YARN_COST_FINAL']
    )   
